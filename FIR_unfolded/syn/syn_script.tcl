...
analyze -f vhdl -lib work ../src/reg16.vhd
analyze -f vhdl -lib work ../src/multiplier_adder.vhd
...
#clock
create_clock -name MY_CLK -period 5.48 CLK
...
report_timing > report_timing_file_period0.txt
